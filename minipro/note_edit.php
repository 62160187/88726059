                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-3 text-center">
                            <a href="indexs.php" class="btn btn-light fas fa-caret-square-left col-md-3 text-center" style="font-size: 2.5em; "></a>
                        </div>
                                ...
                                echo '<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="content'. $row['number'] .'">
                                    ...
                                    <div class="modal-content text-center">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="note_confirm_delete.php?number='. $row['number'] .'" type="button" class="btn btn-primary">ยืนยัน</a> 
                                        </div>
                                    </div>
                                    </div>
                                </div>';
